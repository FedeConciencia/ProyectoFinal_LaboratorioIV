        ...
        try {
            ...
            if(request.getParameter("action") != null){
                ...
                if(request.getParameter("action").equals("listar")){
                    ...
                    List<ArticuloInsumo> lista = controlador.buscarAllArticuloInsumo();
                    ...
                    ControladorArticuloInsumo controlador = new ControladorArticuloInsumo();
                    List<ArticuloInsumo> lista = new ArrayList<>();
                    lista.add(controlador.buscarOneArticuloInsumo(Long.parseLong(request.getParameter("idArticuloInsumo"))));
                    Gson gsonBuilder = new GsonBuilder().create();
                    String cadenaJson = gsonBuilder.toJson(lista);
                    respuestaServer = cadenaJson;
                    ...
                    long idRubroArticulo = Long.valueOf(request.getParameter("idRubroArticulo"));
                    LocalDate fechaAlta = LocalDate.parse(request.getParameter("fechaAlta"));
                    String estado = request.getParameter("estado");
                    
                    ControladorArticuloInsumo controlador = new ControladorArticuloInsumo();
                    ArticuloInsumo articuloInsumo = new ArticuloInsumo(denominacion, precioCompra, precioVenta, stockActual, stockMinimo, unidadMedida, esInsumo, idRubroArticulo, fechaAlta, estado);
                    ...
                    ControladorArticuloInsumo controlador = new ControladorArticuloInsumo();
                    ArticuloInsumo articuloInsumo = new ArticuloInsumo(idRubroArticulo, denominacion, precioCompra, precioVenta, stockActual, stockMinimo, unidadMedida, esInsumo, idRubroArticulo, fechaAlta, estado);
                    ...
                    ControladorArticuloInsumo controlador = new ControladorArticuloInsumo();
                    controlador.eliminarArticuloInsumo(Long.valueOf(request.getParameter("idArticuloInsumo")));
                    List<ArticuloInsumo> lista = controlador.buscarAllArticuloInsumo();
                    Gson gsonBuilder = new GsonBuilder().create();
                    String cadenaJson = gsonBuilder.toJson(lista);
                    respuestaServer = cadenaJson;
                    ...
                    ControladorArticuloInsumo controlador = new ControladorArticuloInsumo();
                    controlador.eliminarLogicoArticuloInsumo(idArticuloInsumo, fechaBaja);
                    List<ArticuloInsumo> lista = controlador.buscarAllArticuloInsumo();
                    Gson gsonBuilder = new GsonBuilder().create();
                    String cadenaJson = gsonBuilder.toJson(lista);
                    respuestaServer = cadenaJson;
