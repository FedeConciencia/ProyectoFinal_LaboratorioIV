        ...
        try {
            ...
            if(request.getParameter("action") != null){
                ...
                if(request.getParameter("action").equals("listar")){
                    ...
                    ControladorUsuario controladorUsuario = new ControladorUsuario();  
                    Usuario usuario = new Usuario(user, contraseña, rol, idCliente, fechaAlta, fechaBaja, estado);
                    ...
                    ControladorUsuario controladorUsuario = new ControladorUsuario();  
                    Usuario usuario = new Usuario(idUsuario,user, contraseña, rol, idCliente, fechaAlta, fechaBaja, estado);
