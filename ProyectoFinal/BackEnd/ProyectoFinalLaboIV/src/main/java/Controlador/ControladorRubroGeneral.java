...
public class ControladorRubroGeneral {
    ...
    //METODO PARA INSERTAR RUBRO:
    public void insertarRubroGeneral(RubroGeneral rubro) {
        ...
        try {
            ...
            ps = conexion.prepareStatement("INSERT INTO rubro_general (denominacion, fechaAlta, fechaBaja, estado) VALUES (?, ?, ?, ?)");

            // Se establecen los parámetros y se ejecuta la sentencia.
            ps.setString(1, rubro.getDenominacion());
            ps.setDate(2, Date.valueOf(rubro.getFechaAlta()));
            ps.setDate(3, Date.valueOf(rubro.getFechaBaja()));
            ps.setString(4, rubro.getEstado());
    ...
    //METODO PARA GESTIONAR ACTUALIZACION RUBRO:
    public void actualizarRubroGeneral(RubroGeneral rubro) {
        ...
        try {
            ...
            ps = conexion.prepareStatement("UPDATE rubro_general SET denominacion = ?, fechaAlta = ?, fechaBaja = ?, estado = ?  WHERE idRubro = ? ");
    ...
    public void eliminarRubroGeneral(Long id) {
        ...
        try {
            ...
            ps = conexion.prepareStatement("DELETE FROM rubro_general WHERE idRubro = ?");
    ...
    public RubroGeneral buscarOneRubroGeneral(Long id) {
        ...
        try {
            ...
            ps = conexion.prepareStatement("SELECT *  FROM rubro_general WHERE idRubro = ?");
            ...
            if (rs.next()) {  //si nos devuelve un dato true
                ...
                Long idRubro = rs.getLong(1); //cada numero del parametro hace referencia al dato del campo que se desea obtener = idPersona
                String denominacion = rs.getString(2);
                LocalDate fechaAlta = (rs.getDate(3)).toLocalDate();
                LocalDate fechaBaja = (rs.getDate(4)).toLocalDate();
        ...
        return rubro; //devolvemos el alumno encontrado
    }
    ...
    public List<RubroGeneral> buscarAllRubroGeneral() {
        ...
        Conexion con = new Conexion();
        RubroGeneral rubro = null;
        List<RubroGeneral> listaRubro = new ArrayList<RubroGeneral>();
        PreparedStatement ps = null;  //Este objeto permite guardar las consultas que hacemos a la BD.
        ResultSet rs = null;  // este objeto lo usamos cuando obtenemos algo de la base de datos.
        ...
        try {
            ...
            ps = conexion.prepareStatement("SELECT * FROM rubro_general");
        ...
        return listaRubro; //devolvemos la lista de alumnos encontrado

    }
    
    //DELETE LOGICO RUBRO A TRAVES DE UPDATE:
    ...
    public void eliminarLogicoRubroGeneral(Long id, LocalDate fecha) {
        ...
        try {
            ...
            ps = conexion.prepareStatement("UPDATE rubro_general SET fechaBaja = ?, estado = ?  WHERE idRubro = ? ");
