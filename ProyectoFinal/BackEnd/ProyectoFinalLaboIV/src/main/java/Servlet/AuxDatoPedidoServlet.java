...
import Controlador.ControladorAuxDatoPedido;
...
//Se especifica el nombre y ruta de la clase: 'http://localhost:8080/ProyectoFinalLaboIV/AuxDatoPedidoServlet?
@WebServlet(name = "AuxDatoPedidoServlet", urlPatterns = {"/AuxDatoPedidoServlet"})
public class AuxDatoPedidoServlet extends HttpServlet {
