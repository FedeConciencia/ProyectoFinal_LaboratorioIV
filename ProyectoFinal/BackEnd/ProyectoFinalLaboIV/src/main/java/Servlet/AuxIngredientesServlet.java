...
import Controlador.ControladorAuxIngredientes;
        ...
        try {
            ...
            if(request.getParameter("action") != null){
                ...
                if(request.getParameter("action").equals("listar")){
                    ...
                    long idArticuloManuf = Long.valueOf(request.getParameter("idArticulo"));
                    List<AuxIngredientes> lista = controlador.buscarIngredientes(idArticuloManuf);
