...
//Se especifica el nombre y ruta de la clase: 'http://localhost:8080/ProyectoFinalLaboIV/RubroGeneralServlet?
@WebServlet(name = "RubroGeneralServlet", urlPatterns = {"/RubroGeneralServlet"})
        ...
        try {
            ...
            if(request.getParameter("action") != null){
                ...
                if(request.getParameter("action").equals("listar")){
                    ...
                    String rubroJson = gsonBuilder.toJson(listaRubro);
                    respuestaServer = rubroJson;
                    
                }else if(request.getParameter("action").equals("buscar")){
                    
                    ControladorRubroGeneral controlador = new ControladorRubroGeneral();   
                    RubroGeneral rubro = controlador.buscarOneRubroGeneral(Long.parseLong(request.getParameter("idRubro"))); 
                    Gson gsonBuilder = new GsonBuilder().create();
                    ...
                    ControladorRubroGeneral controlador = new ControladorRubroGeneral();
                    RubroGeneral rubroGeneral = new RubroGeneral(denominacion, fechaAlta, fechaBaja, estado);
                    controlador.insertarRubroGeneral(rubroGeneral);
                    Gson gsonBuilder = new GsonBuilder().create();
                    String rubroJson = gsonBuilder.toJson(rubroGeneral);
                    respuestaServer = rubroJson;
                    ...
                    ControladorRubroGeneral controlador = new ControladorRubroGeneral();
                    RubroGeneral rubroGeneral = new RubroGeneral(idRubro, denominacion, fechaAlta, fechaBaja, estado);
