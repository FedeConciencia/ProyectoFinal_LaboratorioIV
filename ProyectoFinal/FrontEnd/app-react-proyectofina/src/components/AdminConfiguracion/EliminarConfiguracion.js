...
const EliminarConfiguracion = (props) => {
    ...
    const eliminarConfiguracion =  async () => {
        ...
        try{
            ...
            const response = await fetch("http://localhost:8080/ProyectoFinalLaboIV/ConfiguracionServlet?action=eliminar&idConfiguracion="+id);
            const res = await response.json();

            //Redireccionar a la pagina form configuracion:
...
export default EliminarConfiguracion;