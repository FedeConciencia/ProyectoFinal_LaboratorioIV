...
const ActualizarRubroGral = (props) => {
    ...
    const getDatos = (datos) => {
        ...
        .catch(error => {
            console.log("Error (ActualizarRubroGeneral)");
            console.log(error);
        })
    }
    ...
    const getRubroGeneral = async () => {
        try {
            ...
            const id = props.match.params.id;
            const response = await fetch("http://localhost:8080/ProyectoFinalLaboIV/RubroGralServlet?action=buscar&idRubro="+id);
            ...
            console.log("Error: (ActualizarRubroGeneral) " + error)
        }
    }
        ...
        <Fragment>
            ...
            <Container>
                <Alert variant="success" className="body">
                    <Alert.Heading className="titulo">FORMULARIO ADMIN ACTUALIZACION RUBRO GENERAL</Alert.Heading>
...
export default ActualizarRubroGral;